                ...
                <div class="box">
                  ...
                  <fieldset>
                    ...
                    <div class="col-lg-4">
                      ...
                      <label for="">Orientaci&oacute;n</label>

                      <div class="input-group">
                          
                        <img src="vistas/img/hojaVertical.jpg" style="width: 35px;" alt="">
                        <img src="vistas/img/hojaHorizontal.jpg" style="width: 35px;" alt="">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="input-group">
                        ...
                        <select name="papelUtilizar" class="form-control" id="">
                          ...
                          <option value="">Couche 11x17 Blanco</option>
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                  ...
                  <div class="input-group row">
                    ...
                    <div class="col-lg-4">
                      ...
                      <!-- <div class="input-group"> -->
                        ...
                        <input type="number" class="form-control" step="deny" placeholder="350.00" name="negativo">
                    ...
                    <div class="col-lg-4">
                      ...
                      <!-- <div class="input-group"> -->
                        ...
                        <input type="number" class="form-control" step="deny" name="placa" placeholder="400.00">
                    ...
                    <div class="col-lg-4">
                      ...
                      <!-- <div class="input-group"> -->
                        ...
                        <input type="number" class="form-control" step="deny" name="horas" placeholder="850.00">
                ...
                <div class="input-group row">
                  ...
                  <div class="col-lg-4">
                    ...
                    <input type="number" class="form-control" min="0" id="totalCosTinHoja" name="totalCosTinHoja">
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" name="diseno" placeholder="0" step="deny">
                ...
                <div class="input-group row">
                  ...
                  <div class="col-lg-4">
                    ...
                    <input type="number" class="form-control" min="0" id = "piezaPorExtendido"name="piezaPorExtendido">
                  ...
                  <div class="col-lg-4">
                    ...
                    <input type="number" class="form-control" min="0"id = "extendidosNecesarios" name="extendidosNecesarios">
                ...
                <!--=====================================
                  ...
                  <div class="col-xs-3" style="padding-right:0px">
                      ...
                      <div class="input-group">
                        ...
                        <label for="">Piezas por extendido</label>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6">
                  ...
                  <input type="number" class="form-control" name="costoTotal" placeholder="173.60" step="deny">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6">
                  ...
                  <input type="number" class="form-control" name="valorIncrementado" placeholder="1.95" step="deny">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6">
                  ...
                  <input type="number" class="form-control" name="precioPublico" id="precioPublico" placeholder="3,390.27" value="25" step="deny">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6" >
                  ...
                  <input type="number" class="form-control" name="ganancia" placeholder="1,651.67" step="deny">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6" >
                  ...
                  <input type="number" class="form-control" name="precioPorPieza" placeholder="3.39" step="deny">
...
// }
  function add(){
    ...
    const cotizacionTamano = $("#anchoExtendido").val() + "x" + $("#altoExtendido").val();
