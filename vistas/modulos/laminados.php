				...
				echo '<tr>
						...
						<!--<td>
						  ...
						  <div class="btn-group">
							...
							<button class="btn btn-warning btnEditarCostoLaminado" idLaminado="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarCostoLaminado"><i class="fa fa-pencil"></i></button>
                ...
                <div class="box-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="editarCostoLaminado" id="editarCostoLaminado" value="">
