...
class ModeloRebobinados{
	...
	static public function mdlEditarRebobinado($tabla, $datos){
		...
		$stmt->bindParam(":editarTres", $datos["tres"], PDO::PARAM_INT);
		$stmt->bindParam(":editarUnoPuntoCinco", $datos["unoPuntoCinco"], PDO::PARAM_INT);
		$stmt->bindParam(":editarUno", $datos["uno"], PDO::PARAM_INT);
