...
class ModeloLaminados{
	...
	static public function mdlEditarLaminado($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET CostoLaminado = :editarCostoLaminado WHERE id = :id");

		$stmt -> bindParam(":id", $datos["id"], PDO::PARAM_STR);
		$stmt->bindParam(":editarCostoLaminado", $datos["editarCostoLaminado"], PDO::PARAM_STR);
